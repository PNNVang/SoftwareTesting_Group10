...
// search từ khóa tồn tại nhưng không overdue
String key = 'Maintain'


WebUI.navigateToUrl('https://trello.com/')

WebUI.click(findTestObject('Object Repository/Page_Boards  Trello/div_recent_board'))

TestObject btnClearAll = findTestObject('Object Repository/btn_clear_filter')
...
WebUI.click(findTestObject('Object Repository/Page_Chat_App  Trello/span_filter'))


WebUI.click(findTestObject('Object Repository/checkbox_overdue'))

WebUI.setText(findTestObject('Object Repository/Page_Chat_App  Trello/input_textfield_filter'),
	key)
...
if (cards.findAll { it.isDisplayed() }.size() > 0) {
	KeywordUtil.markFailedAndStop("FAIL: Vẫn tìm thấy " + cards.size() + " thẻ hiển thị. Giao của 2 điều kiện phải là rỗng!")
} else {
	KeywordUtil.logInfo("PASS: Không có thẻ nào hiển thị (Đúng logic lọc kết hợp).")
}
