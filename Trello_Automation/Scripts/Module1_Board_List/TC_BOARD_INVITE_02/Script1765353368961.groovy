...
//5. Nhập email người cần mời (ví dụ: nguyenvanvang2626@gmail.com)
...
WebUI.setText(inputAddMembers, "nguyenvanvang2626@gmail.com")
WebUI.delay(1) 

WebUI.sendKeys(inputAddMembers, Keys.chord(Keys.ENTER))
WebUI.delay(0.5)

//6. Nhấn nút "Share"
TestObject btnShareInvite = new TestObject("btnShareInvite")
btnShareInvite.addProperty("xpath", ConditionType.EQUALS,
	"//button[@data-testid='team-invite-submit-button']")
