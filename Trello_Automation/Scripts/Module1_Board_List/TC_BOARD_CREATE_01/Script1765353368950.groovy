...
WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/p_troubleshooting guide_jzNA5uVDhk7V5S'))

WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/span_View all closed boards_g4oicM70jgqP7r'))

WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/input__nch-textfield__input a3omnNx_j558kc _229800'))


//4. Nhập tên bảng: "Demo_1"
WebUI.setText(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/input__nch-textfield__input a3omnNx_j558kc _57218e_5'), 
    'Demo_1')

//5. Chọn không gian làm việc (nếu có)
//6. Chỉnh quyền xem có thể là (Private hoặc Public)
WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/div_Visibility_react-select-3-single-value'))

WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/div'))

WebUI.click(findTestObject('Object Repository/Module1_Board_List/Page_Boards  Trello/button_Change to public_ybVBgfOiuWZJtD orot_ed26f4'))
