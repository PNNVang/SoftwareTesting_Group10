...
WebUI.click(findTestObject('Object Repository/Module4_Label_Checklist/Page_New test on Software Testing  Trello/button_Add an item'))
...
if (WebUI.verifyElementPresent(dynamicTextarea, 10, FailureHandling.OPTIONAL)) {
    WebUI.setText(dynamicTextarea, 'Danh mục 1')
} else {
    KeywordUtil.markFailedAndStop("Không tìm thấy textarea theo XPATH dynamic.")
}

WebUI.click(findTestObject('Object Repository/Module4_Label_Checklist/Page_New test on Software Testing  Trello/button_Add_Item_Checklist'))

String title = "Danh mục 1"

TestObject label = new TestObject('dynamicLabel')
label.addProperty(
	"xpath",
	ConditionType.EQUALS,
	"//div[contains(@aria-label, 'Danh mục 1')]"
)
