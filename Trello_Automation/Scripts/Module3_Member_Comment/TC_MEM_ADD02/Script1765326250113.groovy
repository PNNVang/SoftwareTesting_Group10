...
// Avatar của thành viên trong card sau khi được add
TestObject cardMemberAvatar = new TestObject('cardMemberAvatar')
cardMemberAvatar.addProperty(
    "xpath",
    ConditionType.EQUALS,
    "//section[h3='Members']//button[@title='Lê Thị Thanh Ngân (leththanhngan4)']"
)

// Đợi avatar xuất hiện
WebUI.waitForElementVisible(cardMemberAvatar, 15)
WebUI.waitForElementClickable(cardMemberAvatar, 15)

// Click mở popup chi tiết thành viên
WebUI.click(cardMemberAvatar)

WebUI.delay(2)     // Đợi popup xuất hiện
