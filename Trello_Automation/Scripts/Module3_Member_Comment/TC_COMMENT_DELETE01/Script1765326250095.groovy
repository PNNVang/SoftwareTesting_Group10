...
deleteBtn.addProperty("xpath", ConditionType.EQUALS, "//a[text()='Delete']")
WebUI.waitForElementClickable(deleteBtn, 10)
WebUI.click(deleteBtn)

// Click "Delete comment" trong popup
TestObject confirmDeleteBtn = new TestObject("confirmDeleteBtn")
confirmDeleteBtn.addProperty("xpath", ConditionType.EQUALS, "//button[normalize-space()='Delete comment']")
WebUI.waitForElementClickable(confirmDeleteBtn, 10)
WebUI.click(confirmDeleteBtn)

// Verify comment biến mất
TestObject deletedComment = new TestObject("deletedComment")
deletedComment.addProperty("xpath", ConditionType.EQUALS, "//p[contains(text(),'Tôi đã làm được ze ze')]")

WebUI.verifyElementNotPresent(deletedComment, 5)
