...
try {
	...
	TestObject btn = findTestObject('Object Repository/Page_a  Settings  Trello/btn_save_edit_workspace')
	
	WebUI.click(btn)
	
	TestObject messageError = findTestObject('Object Repository/Page_a  Settings  Trello/msg_Error_DisplayName')
