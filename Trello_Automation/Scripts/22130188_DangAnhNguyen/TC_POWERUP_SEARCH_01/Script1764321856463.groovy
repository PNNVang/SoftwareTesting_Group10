...
WebUI.setText(findTestObject('Object Repository/22130188_DangAnhNguyen/Page_Nhm Cy Siu Tc  Trello/input_Power-Ups_react-select-5-input'), 'box')
...
WebUI.setText(findTestObject('Object Repository/22130188_DangAnhNguyen/Page_Nhm Cy Siu Tc  Trello/input_Power-Ups_react-select-5-input'), 'board')
