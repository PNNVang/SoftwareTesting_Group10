...
TestObject cardTC1 = createTestObject('cardTC1', '//a[@data-testid=\'card-name\' and contains(@href, \'c/DxZioavs/3-tc3\') and text()=\'tc3\']')
...
TestObject dropdownRecurrence = createTestObject('dropdownRecurrence', '//div[@data-testid=\'recurrence-select-select--control\']')

WebUI.waitForElementVisible(dropdownRecurrence, 10)

WebUI.click(dropdownRecurrence)

WebUI.delay(1)

TestObject optionWeekdays = createTestObject('optionWeekdays', '//div[contains(@class, \'option\') and contains(text(), \'Monday to Friday\')]')

WebUI.waitForElementVisible(optionWeekdays, 10)

WebUI.click(optionWeekdays)
