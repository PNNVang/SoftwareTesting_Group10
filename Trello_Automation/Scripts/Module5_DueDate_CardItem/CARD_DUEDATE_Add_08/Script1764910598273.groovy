...
TestObject cardTC1 = createTestObject('cardTC1', '//a[@data-testid=\'card-name\' and contains(@href, \'c/Jtzisr3c/8-tc8\') and text()=\'tc8\']')
...
String expectedDateDisplay = convertDateFormat(inputDate // "Dec 6"
    )

String expectedFullText = (expectedDateDisplay + ', ') + inputTimeValue // "Dec 6, 11:03 PM"
