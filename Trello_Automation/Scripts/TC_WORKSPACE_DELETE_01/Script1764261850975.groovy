...
WebUI.click(findTestObject('Object Repository/Page_abcs  Settings  Trello/button_confirm_delele_ws'))
// 6. Ẩn thông báo xóa

WebUI.click(findTestObject('Object Repository/Page_Boards  Trello/show_delete_success'))
WebUI.delay(1)
