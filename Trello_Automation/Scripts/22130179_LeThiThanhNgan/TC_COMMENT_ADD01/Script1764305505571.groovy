...
// 1. Click "Write a comment…"
TestObject writeCommentButton = new TestObject('writeCommentButton')
writeCommentButton.addProperty('xpath', ConditionType.EQUALS, "//button[@data-testid='card-back-new-comment-input-skeleton']")
WebUI.waitForElementClickable(writeCommentButton, 10)
WebUI.click(writeCommentButton)


// 2. Nhập nội dung vào editor
TestObject commentEditor = new TestObject('commentEditor')
commentEditor.addProperty('xpath', ConditionType.EQUALS, "//*[@id='ak-editor-textarea']")
WebUI.waitForElementVisible(commentEditor, 10)
WebUI.sendKeys(commentEditor, "Tôi đã làm được ze ze")


// 3. Click SAVE
TestObject saveCommentButton = new TestObject('saveCommentButton')
saveCommentButton.addProperty('xpath', ConditionType.EQUALS, "//button[@data-testid='card-back-comment-save-button']")
...
// ===============================
// 4) VERIFY COMMENT ĐÃ XUẤT HIỆN
// ===============================

TestObject newComment = new TestObject("newComment")
newComment.addProperty("xpath", ConditionType.EQUALS,
	"//p[contains(text(),'Tôi đã làm được ze ze')]")

WebUI.verifyElementVisible(newComment)

WebUI.comment("✔ Thêm comment thành công!")
