...
WebUI.click(findTestObject('22130242_PhamThanhTai/Page_tc1 on T1  Trello/button_Delete_fix47QBt61Ou3M ybVBgfOiuWZJtD_89b05e'))
...
WebUI.verifyElementText(findTestObject('22130242_PhamThanhTai/Page_tc1 on T1  Trello/div_check'), input)
