...
TestObject cardTC1 = createTestObject("cardTC1", "//a[@data-testid='card-name' and contains(@href, 'c/3FgVNTcR/9-tc9') and text()='tc9']")
WebUI.click(cardTC1)
...
String inputDate = getCurrentDate()
String inputTimeValue = "6:00 AM"
