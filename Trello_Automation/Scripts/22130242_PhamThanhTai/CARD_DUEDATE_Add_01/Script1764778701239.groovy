...
TestObject cardTC1 = createTestObject("cardTC1", "//a[@data-testid='card-name' and contains(@href, 'c/eV7Lq2Zo/1-tc1') and text()='tc1']")
WebUI.click(cardTC1)
...
WebUI.comment("Expected display: " + expectedFullText)
