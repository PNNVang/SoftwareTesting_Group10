...
WebUI.click(findTestObject('Object Repository/Page_Chat_App  Trello/checkbox_assigned_to_me'))

WebUI.click(findTestObject('Object Repository/checkbox_not_marked_complete'))
...
if (cards.findAll { it.isDisplayed() }.size() == 0) {
	KeywordUtil.markFailedAndStop("Không tồn tại thẻ sau khi lọc")
}
