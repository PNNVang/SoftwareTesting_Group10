...
WebUI.click(findTestObject('Object Repository/Page_a  Settings  Trello/btn_CurrentVisibility'))

// 4. Chuyển quyền truy cập sang public


WebUI.click(findTestObject('Object Repository/Page_a  Settings  Trello/div_visibility_public'))
WebUI.delay(1)
