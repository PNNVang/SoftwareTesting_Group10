...
WebUI.click(findTestObject('Object Repository/22130322_PhamNguyenNgocVang/Page_Software Testing  Trello/button_Select a color_Sky'))

WebUI.click(findTestObject('Object Repository/22130322_PhamNguyenNgocVang/Page_Software Testing  Trello/button_Create'))

String title = "Nhắc Nhở"

TestObject label = new TestObject('dynamicSkyLabel')
label.addProperty( "xpath", ConditionType.EQUALS, "//span[contains(@aria-label,'" + title + "') and @data-color='sky']")

WebUI.waitForElementVisible(label, 15)
WebUI.mouseOver(label)
