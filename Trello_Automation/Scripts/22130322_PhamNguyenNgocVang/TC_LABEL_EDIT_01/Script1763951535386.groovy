...
WebUI.setText(findTestObject('Object Repository/22130322_PhamNguyenNgocVang/Page_Software Testing  Trello/input_Title_edit-label-title-input'), 'Cập Nhật')

WebUI.click(findTestObject('Object Repository/22130322_PhamNguyenNgocVang/Page_Software Testing  Trello/button_Select a color_red'))
