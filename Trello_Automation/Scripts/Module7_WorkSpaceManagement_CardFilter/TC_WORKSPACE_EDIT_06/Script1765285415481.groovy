...
String ws = 'Edit 6'
String newnameWs = 'TestWorkspaceNameWithExactlyOneHundredCharactersToVerifyTheBoundaryValueAnalysisRequirementForTrello'
...
try {
	...
	WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/btn_save_edit_workspace'))
