...
// 3. Chọn button Change

WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/btn_CurrentVisibility'))

// 4. Chuyển quyền truy cập sang public


WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/div_visibility_public'))
WebUI.delay(1)
