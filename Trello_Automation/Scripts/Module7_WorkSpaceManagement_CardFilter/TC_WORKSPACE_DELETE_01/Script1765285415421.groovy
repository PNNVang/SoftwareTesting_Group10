...
WebUI.waitForElementPresent(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_abcs  Settings  Trello/h3_text_delete_ws'), 10)
WebUI.scrollToElement(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_abcs  Settings  Trello/h3_text_delete_ws'), 5)

// 3. Chọn text "delete workspace"

WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_abcs  Settings  Trello/h3_text_delete_ws'))

// 4. Nhập lại tên workspace
WebUI.setText(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_abcs  Settings  Trello/input_enter_repeat_name_ws'), 
    ws)
// 5. Chọn delete

WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_abcs  Settings  Trello/button_confirm_delele_ws'))
// 6. Ẩn thông báo xóa

WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_Boards  Trello/show_delete_success'))
WebUI.delay(1)
