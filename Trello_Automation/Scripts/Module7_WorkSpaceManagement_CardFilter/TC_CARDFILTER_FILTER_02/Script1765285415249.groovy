...
WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_Chat_App  Trello/checkbox_assigned_to_me'))

WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/checkbox_not_marked_complete'))
