...
String ws = 'Edit 9'
String newnameWs = 'DescriptionForTestingInputFieldLengthRequirementsExceedingOneHundredCharactersInTrelloWorkspaceSystem'
...
try {
	...
	// 3. Click nút Edit (cây bút) bên cạnh tên Workspace
	WebUI.click(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/btn_edit_workspace'))
	
	// 101 ki tu
	
	WebUI.setText(findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/input_name'), newnameWs)
	
	TestObject btn = findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/btn_save_edit_workspace')
	
	WebUI.click(btn)
	
	TestObject messageError = findTestObject('Object Repository/Module7_WorkSpaceManagement_CardFilter/Page_a  Settings  Trello/msg_Error_DisplayName')
	WebUI.verifyElementPresent(messageError, 0)
	
	WebUI.verifyElementNotClickable(btn, FailureHandling.OPTIONAL)
