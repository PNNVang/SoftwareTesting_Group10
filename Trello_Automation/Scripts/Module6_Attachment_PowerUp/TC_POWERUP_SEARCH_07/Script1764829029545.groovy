...
WebUI.setText(findTestObject('Object Repository/Module6_Attachment_PowerUp/Page_Nhm Cy Siu Tc  Trello/input_Power-Ups_react-select-5-input'), 'điện thoại')
...
WebUI.setText(findTestObject('Object Repository/Module6_Attachment_PowerUp/Page_Nhm Cy Siu Tc  Trello/input_Power-Ups_react-select-5-input'), '日本語')
