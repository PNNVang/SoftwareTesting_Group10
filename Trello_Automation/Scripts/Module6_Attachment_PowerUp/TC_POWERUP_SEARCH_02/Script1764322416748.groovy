...
// WebUI.click(findTestObject('Object Repository/Module6_Attachment_PowerUp/Page_Nhm Cy Siu Tc  Trello/button_Report_ktzI4mkrTz6f4_ sBTPnzftJeBlBT_a94bb6'))
...
WebUI.setText(findTestObject('Object Repository/Module6_Attachment_PowerUp/Page_Nhm Cy Siu Tc  Trello/input_Power-Ups_react-select-5-input'), 'boxxxx')
...
boolean isNoResult = WebUI.verifyElementPresent(
		findTestObject('Object Repository/Module6_Attachment_PowerUp/NoResultMessage'),
		3,
